...
while true; do
    ...
    mpirun -np 2 ./train_gpt2cu \
                -i "dev/data/edu_fineweb10B_rookworld/edu_fineweb_rookworld_train_*.bin" \
                -j "dev/data/edu_fineweb10B_rookworld/edu_fineweb_rookworld_val_*.bin" \
                -o $out_dir \
                -v 250 -s 20000 -g 144 \
                -h 1 \
                -b 32 -t 1024 \
