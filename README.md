...
- `bash run.sh` for 
  ...
  - train minimal model on one GPU for 2500 steps with bs=1 to val-loss ~0.73
  - convert to hf and run self-play eval (avg ~3.5 legal moves, with 260k samples -> 13 legal moves)
